      ...
      <div className="flex items-start justify-between px-6 py-12 max-w-7xl mx-auto gap-10">
        ...
        <div className="flex-1 max-w-lg mt-[-40px] ml-[-40px]">
          <div className="text-center mb-8">
            ...
            <p className="text-4xl text-pink-200 mt-[-20px] font-semibold italic">¡Habla con extraños!</p>
          </div>
        ...
        <div className="flex-1 ml-[130px]">
          <div className="text-center text-white italic text-3xl mb-8 font-semibold">¡Chicas Relevantes!</div>
